...
public class LinkWidgetWidget extends GenericMustacheWidget {
	...
	protected void init(WbdWidget instance) throws WbdException
	{
		...
		instance.defineProperty(new WbdRadioTextProperty("target", null, "Target", "SamePage,NewPage", ""));
	}
	...
	public Properties getPropertiesForViewHelper(WbdGenerator generator, WbdWidget instance, UimData ud) throws WbdException {
		...
		String selected_href = navpoint;
		
		if(switcher.equals("url")){
			selected_href = url;
		}
		...
		properties.setProperty("selected_href", selected_href);
