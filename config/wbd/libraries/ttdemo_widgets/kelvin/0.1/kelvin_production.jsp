...
<%@page import="tooltwist.ttdemo.productionHelpers.KelvinProductionHelper"%>
<%@page import="tooltwist.misc.JspHelper"%>
<%@page import="tooltwist.ecommerce.AutomaticUrlParametersMode"%>
<%@page import="tooltwist.ecommerce.RoutingUIM"%>
<%
	// Get the production helper for this widget
	KelvinProductionHelper h = (KelvinProductionHelper) helper;
	XData data = h.getData(jh);
%>

<!-- ********** INSERT HTML HERE ********** -->
<div %%idDefinition%% class="Kelvin" style="width:200px; border-style:solid; border-width:1px; text-align: center;">
	kelvin
